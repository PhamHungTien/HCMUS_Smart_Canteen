const translations = {
  vi: {
    ...
    orders: 'Đơn hàng',
    pickup_time: 'Thời gian lấy',
    revenue: 'Doanh thu',
    reviews: 'Đánh giá & Góp ý',
    users: 'Người dùng',
    ...
    error_slot_full: 'Khung giờ này đã đầy, vui lòng chọn thời gian khác!',
  ...
  en: {
    ...
    error_slot_full: 'This time slot is full, please choose another!',
